...
the new artifact passes its X4 smoke test. Base CrossPoint 1.5.0 is the current
physically booted recovery firmware. `33f07db7` remains the built unmodified
upstream baseline.
